...
<div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white py-16 px-8 flex flex-col items-center">
      ...
      {showCustomForm && (
        <div className="bg-white text-blue-800 py-4 px-6 rounded-md mt-8 shadow w-full max-w-xl">
    ...
    <div className="container mx-auto py-12 px-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
